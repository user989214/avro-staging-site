  ...
  return (
    <>
      <style>{`
        ...
        .blog-cat-btn:hover,
        .blog-cat-btn.active { background-color: var(--charcoal) !important; color: var(--bone) !important; border-color: var(--charcoal) !important; }
          ...
          {categories.map((cat, i) => (
            <button
              ...
              style={{
                ...
                backgroundColor: i === 0 ? "var(--charcoal)" : "transparent",
                color: i === 0 ? "var(--bone)" : "var(--charcoal)",
              }}
            >
              {cat}
            </button>
          ...
          >
            ...
            <div style={{ flex: "1 1 300px", minWidth: 0 }}>
              <div className="flex items-center gap-3 mb-5">
                ...
                <span
                  style={{ width: 4, height: 4, borderRadius: "50%", backgroundColor: "rgba(255,255,255,0.3)", flexShrink: 0 }}
                />
            ...
            >
              ...
              <div>
                <div className="flex items-center gap-2.5 mb-3.5">
                  <span
                    className="blog-card-cat font-sans font-bold text-[14px]"
                    style={{ color: "var(--ink)" }}
                  >
                    {post.category}
                  </span>
                  <span
                    style={{ width: 3, height: 3, borderRadius: "50%", backgroundColor: "var(--divider)", flexShrink: 0 }}
                  />
                  <span
                    className="blog-card-meta font-sans text-[14px]"
