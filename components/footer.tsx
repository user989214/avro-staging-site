...
const footerLinks = {
  ...
  learn: [
    ...
    { href: "/our-story#team", label: "The Team" },
  ...
  follow: [
    { href: "https://www.instagram.com/avrohydrate", label: "Instagram" },
    { href: "https://www.linkedin.com/company/avrohydrate", label: "LinkedIn" },
  ],
}
            ...
            {submitted ? (
              ...
              >
                ...
                <input
                  ...
                  className="flex-1 min-w-0 px-5 py-3 bg-transparent border-0 outline-none placeholder:opacity-50"
                  style={{
                    fontWeight: 400,
                    fontSize: "14px",
                    color: c.text,
                ...
                <button
                  type="submit"
                  className="flex items-center justify-center gap-1.5 shrink-0 whitespace-nowrap px-4 py-2 cursor-pointer hover:opacity-90 transition-opacity"
                  style={{
                    fontWeight: 700,
                    fontSize: "13px",
