...
export function MoodGraph({ formulaKey }: MoodGraphProps) {
  ...
  return (
    <div className="w-full max-w-[600px] mx-auto">
      <div className="relative h-[280px] bg-white rounded-xl border border-line p-6">
        {/* Y-axis label */}
...
export function IngredientBar({ 
  ...
  return (
    <div className={`flex items-center gap-4 p-4 rounded-lg border ${highlight ? "border-avro-blue bg-avro-blue/5" : "border-line bg-white"}`}>
